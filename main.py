...
#                 position = (combined_image.shape[1] // grid_size * (j + 1) + 10, cell_h * i + 20)

#                 combined_image = cv2.putText(combined_image, text1, position, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text2, (position[0], position[1] + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text3, (position[0], position[1] + 40), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text4, (position[0], position[1] + 60), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text5, (position[0], position[1] + 80), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text6, (position[0], position[1] + 100), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text7, (position[0], position[1] + 120), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text8, (position[0], position[1] + 140), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
#                 combined_image = cv2.putText(combined_image, text9, (position[0], position[1] + 160), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
...
#         grid_size = st.slider("Select grid size for comparison", 2, 5, 3)
#         differences = compare_cells_ml(image1, image2, grid_size)
#         combined_image = visualize_differences(image1, image2, grid_size, differences)
